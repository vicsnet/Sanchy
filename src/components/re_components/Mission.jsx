        ...
        <div>
          <div className="h-auto flex md:gap-28 ">
            ...
            <div className=" md:pt-[90px] ">
              ...
              <p className="w-[100%] text-[18px] text-center md:text-left leading-8 mt-8 relative md:mt-4 text-[#80828E] md:w-[90%]">
          ...
          <div className="h-auto flex md:gap-20 lg:gap-28 mt-11">
            ...
            <div className=" md:pt-[90px] ">
              ...
              <p className="w-[100%] text-[18px] text-center md:text-left leading-8 mt-10 relative md:mt-4 text-[#80828E] md:w-[100%]">
