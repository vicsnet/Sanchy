    ...
    <div className="w-[100%] h-auto mb-20 ">
      <div className="w-[90%] flex space-between mx-auto  mt-[10%] mb-auto ">
        <div className="w-[50%]">
          ...
          <p className="w-[90%] text-[18px] h-auto leading-8 font-normal">
          ...
          <div>
            <h3 className=" text-[24px] h-auto w-[50%] text-[#001EDC] mt-[24px] mb-4 ">
              Accountability
            </h3>
            ...
            <p className="w-[80%] text-[18px] h-auto leading-8 font-normal">
              ...
              Every little goal achieved brings us closer to the ultimate vision
              we have. The ability to be in the moment and do what’s important
              keeps us going.
            </p>
            <h3 className=" text-[24px] h-auto w-[50%] text-[#001EDC] mt-[24px] mb-4">
              Dedication
        ...
        <div className=" w-[50%] h-auto">
          <img
            src={Core11}
            alt=""
            className=" w-[60%] h-auto mx-auto mt-[30%]  "
          />
        </div>
      </div>
    </div>
